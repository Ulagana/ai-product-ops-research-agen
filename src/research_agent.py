#!/usr/bin/env python3
"""
Composio AI Product Ops - 100 App Integration Research Agent
Automated pipeline to analyze 100 SaaS apps across 10 categories for agent-callable toolkit buildability.
"""
...
RAW_APPS_DATA = [
    ...
    },
    {
        ...
        "website": "hubspot.com",
        "category": "CRM and Sales",
        "description": "Inbound marketing, sales CRM, and customer service platform.",
        "auth_methods": ["OAuth2", "Private App Token"],
    ...
    },
    {
        ...
        "category": "CRM and Sales",
        "description": "Pipeline-focused sales CRM for small and medium teams.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Trial",
    ...
    },
    {
        ...
        "website": "attio.com",
        "category": "CRM and Sales",
        "description": "Next-gen customizable data-driven CRM built for modern teams.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Free",
    ...
    },
    {
        ...
        "website": "podio.com",
        "category": "CRM and Sales",
        "description": "Customizable project management and workspace collaboration tool by Citrix.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "close.com",
        "category": "CRM and Sales",
        "description": "Inside sales CRM designed for high-volume outreach and call logging.",
    ...
    },
    {
        ...
        "category": "Support and Helpdesk",
        "description": "AI-first customer service platform and live chat software.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST (v2.11 API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Official & Community MCP",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "Support and Helpdesk",
        "description": "Cloud-based customer support software by Freshworks.",
        "auth_methods": ["API Key", "OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "front.com",
        "category": "Support and Helpdesk",
        "description": "Customer communication hub combining emails, chats, and tickets.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Support and Helpdesk",
        "description": "B2B support platform operating natively across Slack, Teams, and email.",
        "auth_methods": ["API Key"],
    ...
    },
    {
        ...
        "category": "Support and Helpdesk",
        "description": "Helpdesk software featuring live chat, ticketing, and call center.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST (v3 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "plain.com",
        "category": "Support and Helpdesk",
        "description": "API-first support platform built specifically for modern engineering teams.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Free",
    ...
    },
    {
        ...
        "category": "Support and Helpdesk",
        "description": "Dedicated customer service suite and shared inbox for growing teams.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "twilio.com",
        "category": "Communications and Messaging",
        "description": "Programmable cloud communications platform for SMS, Voice, and Video.",
    ...
    },
    {
        ...
        "category": "Communications and Messaging",
        "description": "Team chat and business communication software inside Zoho ecosystem.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "pumble.com",
        "category": "Communications and Messaging",
        "description": "Free team chat and collaboration app alternative to Slack.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST",
        "api_breadth": "Moderate",
    ...
    },
    {
        ...
        "category": "Communications and Messaging",
        "description": "Global communications APIs for SMS, voice, video, and 2FA.",
    ...
    },
    {
        ...
        "category": "Marketing, Ads, Email and Social",
        "description": "B2B targeted advertising and campaign management platform.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (RESTli API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Tool-Callable (REST)",
        "buildability_verdict": "Buildable with Auth Setup",
    ...
    },
    {
        ...
        "category": "Marketing, Ads, Email and Social",
        "description": "All-in-one white-label marketing and CRM platform for agencies.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Marketing, Ads, Email and Social",
        "description": "Data-driven email and SMS marketing for ecommerce brands.",
        "auth_methods": ["API Key", "OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v3 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "systeme.io",
        "category": "Marketing, Ads, Email and Social",
        "description": "All-in-one sales funnel builder, email marketing, and course host.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v1 API)",
        "api_breadth": "Moderate",
    ...
    },
    {
        ...
        "category": "Marketing, Ads, Email and Social",
        "description": "Visual discovery and advertising engine.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v5 API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Community MCP",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "Marketing, Ads, Email and Social",
        "description": "Transactional and marketing email delivery infrastructure by Twilio.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v3 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Ecommerce",
        "description": "Website builder and commerce platform for small businesses.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST (1.0 API)",
        "api_breadth": "Moderate",
        "mcp_status": "Tool-Callable (REST)",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "Ecommerce",
        "description": "Easiest platform for creators to sell digital products and subscriptions.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Moderate",
    ...
    # 6. Data, SEO and Scraping
    {
        ...
        "description": "Comprehensive SEO and web data scraping API suite.",
        "auth_methods": ["Basic", "API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v3 API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Community MCP",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "SEO audit, keyword research, and rank tracking software.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST (v1 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "Industry standard backlink checker, keyword research, and SEO tools.",
        "auth_methods": ["API Key", "OAuth2"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST (v3 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "Visual web scraper and automated data extraction cloud service.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST",
        "api_breadth": "Moderate",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "Full-stack web scraping and data extraction cloud platform.",
        "auth_methods": ["API Key", "Bearer Token"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST & Client SDKs",
        "api_breadth": "Comprehensive",
        "mcp_status": "Official & Community MCP",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "Open-source Python CLI OSINT tool to hunt down social media usernames across 400+ sites.",
        "auth_methods": ["None"],
        "access_tier": "Self-Serve Free",
        "api_surface": "CLI / Library",
        "api_breadth": "Comprehensive",
        "mcp_status": "Community MCP",
        "buildability_verdict": "Ready to Build",
    ...
    },
    {
        ...
        "category": "Data, SEO and Scraping",
        "description": "Waterfall data enrichment platform aggregating contact and company intelligence.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST",
        "api_breadth": "Moderate",
    ...
    },
    {
        ...
        "category": "Developer, Infra and Data platforms",
        "description": "Frontend cloud platform for static web applications and serverless functions.",
        "auth_methods": ["Bearer Token", "OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v9/v10 API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Official & Community MCP",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "Developer, Infra and Data platforms",
        "description": "Web hosting and serverless backend services platform.",
        "auth_methods": ["Bearer Token", "OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v1 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Developer, Infra and Data platforms",
        "description": "Global edge network, security, DNS, and serverless platform.",
        "auth_methods": ["API Key", "Bearer Token"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v4 API)",
        "api_breadth": "Comprehensive",
        "mcp_status": "Official & Community MCP",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    # 8. Productivity and Project Management
    {
        ...
        "description": "Connected workspace for notes, docs, task management, and databases.",
        "auth_methods": ["OAuth2", "Bearer Token"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v1 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Productivity and Project Management",
        "description": "Purpose-built issue tracker for high-performance software teams.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "GraphQL API",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Productivity and Project Management",
        "description": "Customizable work OS for project management and team workflows.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "GraphQL API",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "paygent.co.jp",
        "category": "Finance and Fintech",
        "description": "Japanese payment gateway provider powered by NMI ecommerce platform.",
        "auth_methods": ["Basic", "API Key"],
        "access_tier": "Partner Only / Contact Sales",
    ...
    },
    {
        ...
        "category": "Finance and Fintech",
        "description": "Cloud-based accounting software platform for small businesses.",
        "auth_methods": ["OAuth2"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST (v2 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "Finance and Fintech",
        "description": "Corporate credit card, spend management, and business banking platform.",
        "auth_methods": ["OAuth2", "User Token"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST",
        "api_breadth": "Comprehensive",
        "mcp_status": "Community MCP",
    ...
    },
    {
        ...
        "category": "Finance and Fintech",
        "description": "Finance automation and corporate card platform.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Paid",
        "api_surface": "REST (v1 API)",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "category": "AI, Research and Media-native",
        "description": "AI search engine for peer-reviewed scientific research papers.",
        "auth_methods": ["API Key"],
        "access_tier": "Admin / Approval Gated",
        "api_surface": "REST",
        "api_breadth": "Moderate",
    ...
    },
    {
        ...
        "category": "AI, Research and Media-native",
        "description": "AI video generation and camera control engine for social media creators.",
        "auth_methods": ["API Key", "CLI Auth"],
        "access_tier": "Self-Serve Free",
        "api_surface": "CLI & REST",
        "api_breadth": "Moderate",
        "mcp_status": "Tool-Callable (REST)",
        "buildability_verdict": "Ready to Build",
        "main_blocker": "None / Ready",
    ...
    },
    {
        ...
        "category": "AI, Research and Media-native",
        "description": "API to fetch subtitles and transcripts for any public YouTube video.",
        "auth_methods": ["API Key"],
        "access_tier": "Self-Serve Free",
        "api_surface": "REST",
        "api_breadth": "Comprehensive",
    ...
    },
    {
        ...
        "website": "grain.com",
        "category": "AI, Research and Media-native",
        "description": "AI meeting intelligence platform for revenue and product research teams.",
        "auth_methods": ["OAuth2", "API Key"],
        "access_tier": "Self-Serve Trial",
        "api_surface": "REST",
        "api_breadth": "Moderate",
...
def run_research():
    print(f"[Composio Research Agent] Initiating audit across {len(RAW_APPS_DATA)} target applications...")
    
    os.makedirs("data", exist_ok=True)
    
    # Save primary dataset
    json_path = os.path.join("data", "apps_100.json")
    with open(json_path, "w", encoding="utf-8") as f:
        json.dump(RAW_APPS_DATA, f, indent=2)
        
    print(f"[Composio Research Agent] Successfully saved dataset to {json_path}")
